...
#include <queue>
using namespace std;
//***** Steps to run at an online compiler ***** 
//-fopenmp add besides compiler
//x86-64 gcc 13.1 compiler
//use site https://godbolt.org/
/// output in botttom down left one 
class Graph
{
private:
    int vertices;
...
public:
    ...
    void addEdge(int u, int v)
    {
        ...
        adjList[v].push_back(u); //comment for undirected graph
    }
